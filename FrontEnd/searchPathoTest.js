...
function loadTest()
{
    ...
    var url="http://localhost:8080/examinationPathos/"+testId.value;
    var httpObj=createCORSRequest("GET",url);
    httpObj.open("GET",url,true);
    httpObj.onload=function()
    {
        if(this.readyState=4 && this.status==200)
        {
            ...
            examDetails=data.examPathoDetails;
            examName=data.examPathoName;
            examRes=data.examPathoRes;
    ...
    httpObj.onload=function()
    {
        ...
        {   
            ...
            for(var i=0;i<data1.length;i++){
                ...
                examStatus=data.examStatus;
                if(examRes!=0)
                    toBeHtml1+="<tr><td class=\"other1\">"+data.examPathoId+"</td><td class=\"other1\">"+examName+"</td><td class=\"other1\">"+examDetails+"</td><td class=\"other1\">"+examStatus+"</td><td class=\"other1\"><input type=\"button\" value=\"View Results\" style=\"border-radius:20px;\" onclick=\"download("+examRes+")\"></td></tr>";
                else
                    toBeHtml1+="<tr><td class=\"other1\">"+data.examPathoId+"</td><td class=\"other1\">"+examName+"</td><td class=\"other1\">"+examDetails+"</td><td class=\"other1\">"+examStatus+"</td><td class=\"other1\">Not Uploaded</td></tr>";
